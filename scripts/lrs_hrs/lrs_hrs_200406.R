...
ggplot(mean_inh, aes(x = index, y = mean_inh)) + geom_line() + geom_point() + 
  geom_vline(xintercept = 7, col = "gray") +
  geom_vline(xintercept = 76, col = "gray") + 
...
clustered = cluster_superpixels(slic[, c("L", "A", "B")], 76, w)
plotRGB(raster)
...
# -88.8341275   0.6215677  82.0231558   0.1654607   0.8072620 

# 76
#        AFI    D_index   OMerging   UMerging     recall 
# -4.8242172  0.6280095  2.1138604  0.7308133  0.4542268 
