...
raster = rast("data/Poznan/ready/orto_170519.tif")
...
ggplot(smst, aes(x = seg_num, y = roclv)) + geom_line() + geom_vline(xintercept = 50, col = "red") + geom_vline(xintercept = 53, col = "grey") +
  xlab("Number of clusters") + ylab("ROC-LV")

clustered = cluster_superpixels(slic[, c("r", "g", "b")], 53, w)
plot(raster)
