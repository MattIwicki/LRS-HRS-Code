...
ggplot(smst, aes(x = seg_num, y = roclv)) + geom_line() + geom_vline(xintercept = 55, col = "red") + geom_vline(xintercept = 64, col = "grey") +
  xlab("Number of clusters") + ylab("ROC-LV")

clustered = cluster_superpixels(slic[, c("r", "g", "b")], 64, w)
plot(raster)
